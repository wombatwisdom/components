...
func (m *Output) Connect(ctx context.Context) error {
	m.connMut.Lock()
...
func (m *Output) Write(ctx context.Context, message spec.Message) error {
	m.connMut.RLock()
	client := m.client
	m.connMut.RUnlock()
...
func (m *Output) Disconnect(context.Context) error {
	m.connMut.Lock()
	defer m.connMut.Unlock()
